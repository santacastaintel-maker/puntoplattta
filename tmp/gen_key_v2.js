...
const type = 'mensual';
const timestamp = 1776057078000; // 2026-04-12T21:11:18-06:00
...
console.log('USER:' + cleanName);
console.log('EXPIRY:' + expiresAt);
console.log('DATA:' + dataString);
console.log('HASH:' + hashVal);
console.log('SIGN:' + hashSignature);
console.log('B36:' + expiresBase36);
console.log('FINAL_KEY:' + key);
