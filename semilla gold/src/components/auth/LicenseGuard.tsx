...
import { ShieldAlert, KeyRound, CheckCircle2, AlertTriangle, X } from 'lucide-react';
                ...
                <div className="max-w-md w-full bg-white rounded-3xl shadow-2xl p-8 relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                        ...
                        <form onSubmit={handleActivate} className="w-full space-y-5">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-slate-700 mb-1">Llave de Activación</label>
                                <input
                                    type="text"
                                    value={licenseKey}
